    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
        if AUTH_CHANNEL:
            ...
            try:
                ...
                await bot.send_message(
                    chat_id=message.from_user.id,
                    text="**ചാനലിൽ നിങ്ങൾ ഉണ്ട് എങ്കിൽ മാത്രമേ നിങ്ങൾക്ക് മൂവി ഈ ബോട്ട് വഴി ലഭിക്കുകയുള്ളു. ആദ്യം താഴെ ഉള്ള ലിങ്കിൽ ക്ലിക്ക് ചെയ്തു ജോയിൻ ആകുക. അതു കഴ്ഞ്ഞു.താഴെയുള്ള Try 𝙰𝚐𝚊𝚒𝚗 കൊടുക്കുക😁!**",
